<?php
	...
	/**
	 * This method is a convenience method that returns a stored
	 * instance of the mysqli connection to the MySQL server or
	...
	/**
	 * Initializes the connection to the MySQL database. This should only
	 * be called by get_mysql_connection().
	 * @return mysqli the initialized MySQL connection
	 */
	 ...
	 * @return string the relative location of the MySQL config file.
	 */
